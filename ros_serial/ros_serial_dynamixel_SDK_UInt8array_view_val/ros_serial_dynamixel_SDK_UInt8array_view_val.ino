...
#include <std_msgs/UInt16MultiArray.h>                  //uint16multiarray 배열로 선언하기 위한 헤더파일
...
ros::Subscriber<std_msgs::UInt16MultiArray> sub("cmd_val", messageCb );   //sub를 uint16multiarray로 받기 위한 설정 cmd_val토픽명의 토픽 데이터를 받아 messageCb
