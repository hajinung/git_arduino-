...
void temp_write(int want1_speed, int want2_speed)
{
  digitalWrite(22, HIGH);
  ...
  Speed1 = map(want1_speed, 0, 2047, Speed1_MIN, Speed1_MAX );

  int Speed2_MIN = 0, Speed2_MAX = 2047;

  int Speed2;

  Speed2 = map(want2_speed, 0, 2047, Speed2_MIN, Speed2_MAX);
