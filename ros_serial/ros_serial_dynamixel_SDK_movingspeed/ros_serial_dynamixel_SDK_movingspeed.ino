...
//다이나믹셀 핸들러
  ...
  int dxl_moving = DXL_VALUE;         // Goal position -> 다이나믹셀 DXL_MINIMUM_POSITION_VALUE 값을 받아서 dxl_goal_position에 저장
  ...
  // Write goal position
   packetHandler->write2ByteTxRx(portHandler, DXL_ID, ADDR_MX_MOVING, dxl_moving, &dxl_error);
